    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul className="nav">
          ...
          <li className={ this.isPathActive('/vmaster') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <Link className="nav-link" to="/vmaster">
              <span className="menu-icon"><i className="mdi mdi-speedometer"></i></span>
              <span className="menu-title"><Trans>Vehicle Master</Trans></span>
            </Link>
          </li>
          ...
          <li className={ this.isPathActive('/form-elements') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <div className={ this.state.formElementsMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('formElementsMenuOpen') } data-toggle="collapse">
              ...
              <span className="menu-title">
                <Trans>Form Elements</Trans></span>
              <i className="menu-arrow"></i>
            ...
            <Collapse in={ this.state.formElementsMenuOpen }>
              <div>
                <ul className="nav flex-column sub-menu">
                  ...
                  <li className="nav-item"> <Link className={ this.isPathActive('/form-elements/basic-elements2') ? 'nav-link active' : 'nav-link' } to="/form-elements/basic-elements2"><Trans>Basic Elements2</Trans></Link></li>
                </ul>
              </div>
            </Collapse>
          </li>
